  ...
  <v-dialog v-model="showDialog" persistent max-width="400">
    <v-card>
      ...
      <v-card-text class="vCartContainer">
        ...
        >
          ...
          <div v-if="exportState === STATES.normal">
            ...
            -->
            <v-select
              v-if="groupSelected && groupSelected !== 'All'"
          ...
          <!--
           ...
           -->
          <div v-else>
            <div class="message" v-if="exportState === STATES.success">
              <v-icon color="green" large>check</v-icon>
              <div>Success</div>
            </div>
        ...
        <!--
          Loading
        -->
        <div class="_container loadingContainer" v-if="isLoading">
          <v-progress-circular
            :size="70"
            :width="7"
            color="blue"
      ...
      <v-card-actions class="cardActions">
        <v-btn flat @click="closeEventDialog" color="red" outline>
          <v-icon>close</v-icon>
          close
        </v-btn>
