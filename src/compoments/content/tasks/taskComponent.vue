  ...
  <div class="taskContainer">
    ...
    <div class="header">
      <div class="backButton">
        <v-btn class="goBackBtn ma-2" flat @click="goBack">
          back
        </v-btn>
      </div>
      ...
      <div class="othersButtons" @click="seeOrHideColor">
        <v-btn flat icon>
          <v-icon>
      ...
      <v-list two-line>
        ...
        >
          ...
          <v-list-tile-action>
            <v-checkbox
              v-model="task.done"
              @change="validItem(task)"
            ></v-checkbox>
          </v-list-tile-action>

          <v-list-tile-action>
            <!-- <v-icon>chat</v-icon> -->
            <v-btn @click.stop="openCommentDialog(task)" flat icon>
              <v-icon>chat</v-icon>
            </v-btn>
          </v-list-tile-action>
        </v-list-tile>
...
export default {
  ...
  created() {
    spinalBackend.calendarService
      .getEventTasks(this.eventSelected.eventId)
      .then(tasks => {
        this.tasks = tasks;
